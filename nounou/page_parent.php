...
// instanciations
$all_nounou = new Fonctions($db);
$nounous = $all_nounou->afficher_nounou();
...
<body>
    <header>
        ...
        <div class="nav-down">
            ...
            <button id="btn-compte2">
                <span class="material-symbols-outlined">person</span>
               
            </button>
            <a class="lien-deco" href="?logout=true">Deconnexion</a>
        </div>
        <div class="liste">
            <nav>
                <li><a href="#">Programmes</a></li>
                <li ><a href="#">Messagerie</a></li>
                <li ><a href="#">Signaler nounou</a></li>
                <li ><a href="#">Gerer compte</a></li>
                <li class="lien"><a href="#">Déconnexion</a></li>
            </nav>
        </div>
    </header>
    <main> 
        ...
        <div class="case-middle">
            ...
            foreach($nounous as $nounou){
                $id = $nounou['id'];
                $nom = $nounou['nom'];
                $prenom = $nounou['prenom'];
                $adresse = $nounou['adresse'];
                echo 
                "<div class='case-nounou'>
                    <section>
                        <span class='material-symbols-outlined'>person</span>
                    </section>
                    <div class='bar'></div>
                    <p>Nom: $nom <br>Pénom: $prenom</p>
                    <a href='php/page_infos.php?id=$id&nom=$nom&prenom=$prenom'><button>Voir profil</button></a>
