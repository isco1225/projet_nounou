...
<body>
    <header>
        <div class="nav-top">
            ...
            <h1><a href="index.php">Nanny Corp<br><span>Agence de placement de Nounou</span></a></h1>
            <button id="btn-connexion">Connexion</button>
            <button id="btn-inscription">Creez un compte</button>
        </div>
        <div class="nav-down">
    ...
    <main> 
        ...
        <div class="message">
            <h1>Connectez vous pour accéder à toutes les fonctionnalités de Nanny Corp</h1>
        </div>
        <div class="comptes">
            <div class="cadre1">
                <button id="btn-nounou">Creez un compte nounou</button>
            </div>
            <div class="cadre2">
                <button id="btn-nounou">Creez un compte parent</button>
